...
// chip id, DEVEUI, APPEUI, APPKEY
static const lora_t lora_table[] = {
    {0x00ABCDEF,  { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, {0x70, 0xB3, 0xD5, 0x00, 0x00, 0x00, 0x00, 0x00}, {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
    {0x00123456,  { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, {0x70, 0xB3, 0xD5, 0x00, 0x00, 0x00, 0x00, 0x00}, {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}}        
};

static const uint8_t loratablesize =
    sizeof(lora_table) / sizeof(lora_table[0]); // number of commands in command table                                
